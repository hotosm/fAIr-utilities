...
def train(
    ...
    if not os.path.exists(weights):
        # url = "https://huggingface.co/Ultralytics/YOLO11/resolve/97c61428146e92d06e5cde0c70308ed8d36a6c34/yolo11n-seg.pt"
    ...
    # back = (
    #     "n"
    #     if "yolov11n" in weights
    #     else "s" if "yolov11s" in weights else "m" if "yolov11m" in weights else "?"
    # )
    back = "n"
    ...
    name = f"yolov11{back}-seg_{dataset}_ep{epochs}_bs{batch_size}"
